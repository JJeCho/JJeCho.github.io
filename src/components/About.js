  ...
  return (
    <div className="about-container">
      ...
      <p className="paragraph1">
        ...
        sculpting digital landscapes where ideas flow freely and experiences
        transcend the ordinary. Each line of code is a brushstroke, painting a
        canvas of endless possibilities. With every project, I embark on a
        journey of self-discovery and innovation, seeking not only to master the
